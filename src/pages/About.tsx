...
export default function About() {
  useSeo({
    ...
    description:
      "Royal Rajasthan Holidays has designed bespoke international and Indian journeys from Jodhpur, Rajasthan since 2005. Our story, mission, values, team and certifications.",
    path: "/about",
    image: IMG.raj6,
  });
