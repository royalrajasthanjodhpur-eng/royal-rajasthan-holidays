...
export function HolidayTypesIndex() {
  useSeo({
    ...
    description:
      "Family holidays, honeymoons, senior citizen tours, luxury travel, group tours, corporate travel, pilgrimage, adventure, wildlife, beach and fully customised holidays.",
    path: "/holidays",
    image: IMG.ppl2,
  });
...
export function HolidayTypeDetail() {
  ...
  useSeo({
    title: h ? `${h.name} — Curated by Royal Rajasthan Holidays` : "Holiday Type",
    description: h?.intro ?? "Bespoke holidays designed around you.",
    path: `/holidays/${slug}`,
    image: h?.image,
  });
